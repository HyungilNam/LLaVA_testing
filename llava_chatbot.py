...
src_img_path = '/home/nam/mount4t2nd/MRLab_23_1/llava/Joyful_test/cropped_video/video_name_frame_0.jpg'
...
def main():
    ...
    ans = chatbot.start_new_chat(img_path=src_img_path, prompt="How many people in the scene?")
    print(ans)

    ans = chatbot.continue_chat("What is the object in front of the man in the scene?")
    print(ans)
